...
<head>
    ...
    <title>Dapoer Umma Admin Register</title>
                                ...
                                <form class="user">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <x-jet-input id="password_confirmation" class="form-control" type="password" name="password_confirmation" placeholder="Password Confirmation" required autocomplete="new-password" />
                                        </div>
                                    </div>
